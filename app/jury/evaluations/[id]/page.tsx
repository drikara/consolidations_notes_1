  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main className="container mx-auto p-6 space-y-6">
        ...
        <Button variant="outline" className="flex items-center gap-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white transition-all duration-200 cursor-pointer my-5">
